...
if (NOT __GLOG_INCLUDED)
  ...
  if (GLOG_FOUND)
    ...
    # build directory
    set(glog_PREFIX ${CMAKE_BINARY_DIR}/third_party/glog)
    # install directory
    set(glog_INSTALL ${CMAKE_BINARY_DIR}/third_party/install/glog)

    set(GLOG_EXTRA_COMPILER_FLAGS "-fPIC -Wno-unused-local-typedefs -Wno-deprecated")
    ...
    ExternalProject_Add(glog
      ...
      CONFIGURE_COMMAND env "CFLAGS=${GLOG_C_FLAGS}" "CXXFLAGS=${GLOG_CXX_FLAGS}" 
          ${glog_PREFIX}/src/glog/configure --prefix=${glog_INSTALL} --enable-shared=no --enable-static=yes 
